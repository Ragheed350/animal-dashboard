...
import { CRUDBuilder, ItemType, RootState, Authenticated, FetchWeightsAsync, DeleteWeightAsync, InsertWeightAsync, UpdateWeightAsync, FetchAnimalsAsync } from '@core';
