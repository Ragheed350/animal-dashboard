...
import { CRUDBuilder, ItemType, RootState, Authenticated, FetchRatesAsync, DeleteRateAsync, InsertRateAsync, UpdateRateAsync, FetchAnimalsAsync, FetchUsersAsync } from '@core';
